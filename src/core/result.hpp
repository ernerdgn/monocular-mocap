...
class Result
{
  ...
  public:
    ...
    static Result<T> err(std::string error_msg)
    {
        return Result<T>(Error{std::move(error_msg)});
    }
    ...
    {
        return std::get<Error>(m_data).msg;
    }
...
class Result<void>
{
  ...
  public:
    ...
    static Result<void> err(std::string error_msg)
    {
        return Result<void>(false, std::move(error_msg));
    }
